...
CREATE TABLE MESSAGES (ID int NOT NULL AUTO_INCREMENT, DATE_SENT date NOT NULL, CONTENT varchar(255), USERS_ID int NOT NULL, PRIMARY KEY (ID), FOREIGN KEY (USERS_ID) REFERENCES USERS (ID));
...
CREATE TABLE AUTHENTICATES(LOGIN VARCHAR(40) UNIQUE NOT NULL, PASSWORD VARCHAR(40) NOT NULL, UNLOCKED_DATE DATE NOT NULL, USERS_ID INTEGER PRIMARY KEY, FOREIGN KEY (USERS_ID) REFERENCES USERS(ID));
