...
CREATE TABLE USERS(ID INTEGER PRIMARY KEY NOT NULL, USER_NAME VARCHAR(50) NOT NULL, EMAIL VARCHAR(50) NOT NULL);


CREATE TABLE AUTHENTICATES(ID INTEGER PRIMARY KEY NOT NULL, LOGIN VARCHAR(50) NOT NULL, PASSWORD VARCHAR(50) NOT NULL);
...
CREATE TABLE ROLES(ID INTEGER NOT NULL, ROLE VARCHAR(50) NOT NULL);
