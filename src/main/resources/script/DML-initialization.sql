...
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USERS_ID) VALUES ('admin', '1', CURRENT_DATE(), 1);

INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('Иван', 'ivan@mail.ru', 1);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USERS_ID) VALUES ('ivan', '1', CURRENT_DATE(), 2);

INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('user', 'user@mail.ru', 1);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USERS_ID) VALUES ('user', '1', CURRENT_DATE(), 3);

INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('lock', 'qwe@mail.ru', 2);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USERS_ID) VALUES ('qwe', '1', CURRENT_DATE(), 4);

INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('limit', 'zak@mail.ru', 3);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USERS_ID) VALUES ('zak', '1', DATEADD('DAY', 5, CURRENT_DATE()) , 5);
